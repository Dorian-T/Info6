...
bin/tests: obj/tests.o obj/Piece.o obj/Soldat.o obj/Siege.o obj/Terrain.o
	g++ -g obj/tests.o obj/Piece.o obj/Soldat.o obj/Siege.o obj/Terrain.o -o bin/tests

obj/tests.o: src/tests.cpp src/Piece.h src/Soldat.h src/Siege.h src/Terrain.h
